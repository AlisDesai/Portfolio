...
export function ScrollWaveTheme() {
  ...
  return (
    <motion.div 
      ...
      className="pointer-events-none fixed inset-0 z-[1] overflow-hidden mix-blend-screen scale-[1.1]"
    >
      ...
      <motion.div
        style={{ y: wave1Y }}
        className="absolute top-[-10%] left-0 h-[120vh] w-[200vw]"
      >
        <motion.div
          animate={{ x: ["0%", "-50%"] }}
        ...
        >
          <svg viewBox="0 0 4800 1000" className="w-full h-full" preserveAspectRatio="none" fill="none">
            <path
              d="M0 500 C400 200, 800 800, 1200 500 C1600 200, 2000 800, 2400 500 C2800 200, 3200 800, 3600 500 C4000 200, 4400 800, 4800 500"
              stroke="url(#scrollGrad1)" strokeWidth="5" filter="url(#scrollGlow)"
            />
          </svg>
        </motion.div>
      </motion.div>
      ...
      <motion.div
        style={{ y: wave2Y }}
        className="absolute top-[10%] left-0 h-[100vh] w-[200vw]"
      >
        <motion.div
          animate={{ x: ["-50%", "0%"] }}
        ...
        >
          <svg viewBox="0 0 4800 1000" className="w-full h-full" preserveAspectRatio="none" fill="none">
            <path
              ...
              stroke="url(#scrollGrad2)" strokeWidth="3" opacity="0.9" filter="url(#scrollGlow)"
            />
          </svg>
        </motion.div>
      </motion.div>
      ...
      <motion.div
        style={{ y: wave3Y }}
        className="absolute top-[40%] left-0 h-[100vh] w-[200vw]"
      >
        <motion.div
          animate={{ x: ["0%", "-50%"] }}
        ...
        >
          <svg viewBox="0 0 4800 1000" className="w-full h-full" preserveAspectRatio="none" fill="none">
            <path
              ...
              stroke="url(#scrollGrad3)" strokeWidth="8" opacity="0.6" filter="url(#scrollGlow)"
            />
          </svg>
        </motion.div>
      </motion.div>
